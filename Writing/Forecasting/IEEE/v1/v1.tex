...
\IEEEPARstart{I}{ncreasing} penetration of renewable energy sources, such as 
wind and solar, in 
...
% %% DP. I  would rather limit to a single contribution. We are not providing 
the 
...
% \fnbelowfloat command of the stfloats packag
